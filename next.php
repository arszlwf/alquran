...
<div class="container">
  ...
  if($amb == ""){
    die('<center><h5>SURAH TERSEBUT TIDAK TERSEDIA<br>CEK PENCARIANMU<hr></h5></center><br><br><a href="index.php"><h1><center><i class="fas fa-backward"></i> KEMBALI</center></h1></a>');
  }
